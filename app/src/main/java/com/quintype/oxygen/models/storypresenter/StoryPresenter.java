...
public class StoryPresenter implements Parcelable {
    ...
    StoryPresenter(Story story, String storyType) {
       ...
       /* if (storyType.equals(STORY_TEMPLATE_LISTICLE) && (!TextUtils.isEmpty(story.bulletType)) && story.bulletType.equals(LISTICLE_BULLETIN_321)) {
        ...
        for (int i = 0; i < cardList.size(); i++) {
            ...
            if (STORY_TEMPLATE_DEFAULT_LIVE_BLOG.equals(storyType))
                addLiveBlogStoryElements(card, null);
     ...
     * @param cls        {@link StoryElementBinder} class type of the Binder.
     */
    public void insertIconWithTitleBinder(int atPosition, Class cls) {
     ...
     * @param cls        {@link StoryElementBinder} class type of the Binder.
     */
    public void insertShareWidgetBinder(int atPosition, Class cls) {
