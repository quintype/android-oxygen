...
class AssociatedMetadata() : Parcelable {
    ...
    @Expose
    var associatedMetadataMagazineStoryPageNumber: Int = 1
    ...
    constructor(parcel: Parcel) : this() {
        ...
        associatedMetadataMagazineStoryPageNumber = parcel.readInt()
    }
    ...
    override fun writeToParcel(parcel: Parcel, flags: Int) {
        ...
        parcel.writeInt(associatedMetadataMagazineStoryPageNumber)
    }
