...
public class Story implements Parcelable {
    ...
    public Story(String id, String slug, String heroImageS3Key, String headline, Long publishedAt) {
        this.id = id;
        this.slug = slug;
    ...
    public Story(String id, String slug, String heroImageS3Key, String headline, Long publishedAt, String authorName) {
        this.id = id;
        this.slug = slug;
        this.heroImageS3Key = heroImageS3Key;
        this.headline = headline;
    ...
    protected Story(Parcel in) {
        ...
        this.mMagazinePageNumber = in.readInt();
        ...
        this.accessLevelValues = in.readString();
        ...
        this.associatedSeriesCollectionIDs = in.createStringArrayList();
        this.contributors = in.createTypedArrayList(ContributorModel.CREATOR);
    }
    ...
    public String toString() {
        return "Story{" +
                ...
                ", mMagazinePageNumber=" + mMagazinePageNumber +
                '}';
    }
    ...
    /**
     * @return List of story contributors
     */
...
//    }
    ...
    public List<String> getAssociatedSeriesCollectionIDs() {
        return associatedSeriesCollectionIDs;
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(this.mMagazinePageNumber);
        ...
        dest.writeString(this.accessLevelValues);
