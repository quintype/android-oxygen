...
import com.quintype.oxygen.models.story.StoryResponse
...
interface StoryServiceApi {
    ...
    fun getStoryDetailBySlug(@Query(OxygenConstants.QUERY_PARAM_KEY_STORY_SLUG) storySlug: String): Single<StoryResponse>
}
