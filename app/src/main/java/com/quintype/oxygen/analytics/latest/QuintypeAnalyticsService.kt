package com.quintype.oxygen.analytics.latest
...
class QuintypeAnalyticsService(mContext: Context, mobileConfig: ConfigModel) {
    ...
    private var mMobileConfig = mobileConfig
    ...
    companion object {
        ...
        fun initialize(context: Context, mobileConfig: ConfigModel): QuintypeAnalyticsService {
            if (null == instance)
                instance =
                    QuintypeAnalyticsService(context, mobileConfig)
    ...
    init {
        generateSessionId()
        mPublisherID = mMobileConfig.publisherId
        appName = mMobileConfig.publisherName + " Android"
    ...
    private fun getShrubberyRetrofitApiClient(): QuintypeAnalyticsApiService {
        ...
        var shrubberyEndPoint: String? = mMobileConfig.shrubberyHost!!
        if (null == shrubberyEndPoint) {
            shrubberyEndPoint = ""
        }
