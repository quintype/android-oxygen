...
class CollectionService {
    companion object {
        ...
        var collectionApiService: CollectionApiService = RetrofitApiClient.getRetrofitApiClient().create(
            CollectionApiService::class.java)
    ...
    fun getCollectionResponse(collectionSlug: String, pageNumber: Int): LiveData<BulkTableModel> {
        ...
        mCompositeDisposable?.add(
            collectionApiService.getCollectionApiService(collectionSlug, Constants.PAGE_LIMIT, pageNumber * Constants.PAGE_LIMIT, Constants.STORY_FIELDS)
...
//                            mCollectionSize = 4
    ...
    fun getChildRxResponse(collectionSlug: String, limit: Int, offset: Int) {
        val collectionApiService: CollectionApiService = RetrofitApiClient.getRetrofitApiClient().create(
            CollectionApiService::class.java)
